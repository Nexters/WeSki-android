...
internal fun <T> DependencyHandler.runtimeOnly(dependencyNotation: Optional<Provider<T>>): Dependency? =
	add("runtimeOnly", dependencyNotation.get())